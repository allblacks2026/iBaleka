...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void initializeControls()
    {
        ...
        activityPreferences = getSharedPreferences("MainActivityPrefs", MODE_PRIVATE);
    ...
    public void loadLandingScreenFragment()
    {
        ...
        transaction.commit();
        String res = "Welcome " + appSharedPreferences.getString("Username", "User");
        toolbarTextView.setText(res);
    }
    @Override

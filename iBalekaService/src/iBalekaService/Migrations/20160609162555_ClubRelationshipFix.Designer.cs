...
namespace iBalekaService.Migrations
{
    ...
    [Migration("20160609162555_ClubRelationshipFix")]
    partial class ClubRelationshipFix
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("iBalekaService.Models.Athlete", b =>
                {
                    b.HasOne("iBalekaService.Models.Club_Athlete")
                        .WithOne()
                        .HasForeignKey("iBalekaService.Models.Athlete", "MemberID");
                });
